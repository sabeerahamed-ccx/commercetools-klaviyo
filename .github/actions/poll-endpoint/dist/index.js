        ...
        try {
            ...
            while (Date.now() - startTime < timeout) {
                try {
                    ...
                    _actions_core__WEBPACK_IMPORTED_MODULE_0__.debug(method);
                    _actions_core__WEBPACK_IMPORTED_MODULE_0__.debug(url);
                    _actions_core__WEBPACK_IMPORTED_MODULE_0__.debug(`${headers}`);
                    const response = yield client.request(method, url, null, headers);
